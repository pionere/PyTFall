screen pyp_school():
    ...
    fixed:
        ...
        fixed:
            ...
            frame:
                xalign .5
                add PyTGFX.scale_img("content/gfx/interface/pyp/school.webp", 360, 1000)

        hbox:
            align 1.0, 1.0
            spacing 4
            frame:
                add PyTGFX.scale_img("content/gfx/interface/pyp/courses.webp", 262, 1000)
            frame:
                add PyTGFX.scale_img("content/gfx/interface/pyp/courses_1.webp", 264, 1000)
