screen pyp_buildings_and_businesses():
    ...
    fixed:
        ...
        fixed:
            ...
            frame:
                ypos 80
                add PyTGFX.scale_img("content/gfx/interface/pyp/b_and_b.webp", 350, 1000)
...
screen pyp_buildings():
    ...
    fixed:
        ...
        fixed:
            ...
            frame:
                ypos 80
                add PyTGFX.scale_img("content/gfx/interface/pyp/building.webp", 350, 1000)
...
screen pyp_businesses():
    ...
    fixed:
        ...
        fixed:
            ...
            frame:
                ypos 80
                add PyTGFX.scale_img("content/gfx/interface/pyp/businesses.webp", 350, 1000)
...
screen pyp_clients():
    ...
    fixed:
        ...
        fixed:
            ...
            frame:
                ypos 80
                add PyTGFX.scale_img("content/gfx/interface/pyp/clients.webp", 350, 1000)
...
screen pyp_building_stats():
    ...
    fixed:
        ...
        fixed:
            ...
            frame:
                ypos 350
                add PyTGFX.scale_img("content/gfx/interface/pyp/building_stats.webp", 350, 1000)
...
screen pyp_advertising():
    ...
    fixed:
        ...
        fixed:
            ...
            frame:
                ypos 80
                add PyTGFX.scale_img("content/gfx/interface/pyp/advertising.webp", 350, 1000)
...
screen pyp_manager():
    ...
    fixed:
        ...
        fixed:
            ...
            frame:
                ypos 80
                add PyTGFX.scale_img("content/gfx/interface/pyp/manager.webp", 350, 1000)
...
screen pyp_workers():
    ...
    fixed:
        ...
        fixed:
            ...
            frame:
                ypos 80
                add PyTGFX.scale_img("content/gfx/interface/pyp/workers.webp", 350, 1000)
...
screen pyp_chworkers():
    ...
    fixed:
        ...
        fixed:
            ...
            vbox:
                ypos 80
                text ("In order to have a succesful business it's important to understand how well characters can handle tasks." +
                      " First of all, ideally workers tiers thould be equal or higher than building tier." +
                      ...
                      "\n\nAdditionally, try to match characters class(es) with their jobs. Character may agree to do job she's unfamiliar with," +
                      " but her performance will be very low compared to professionals. If you want to clean a building, better search for a Cleaner." +
                      " If you need to show striptease, better look for a Stripper. And so on.")
...
screen pyp_jobs():
    ...
    fixed:
        ...
        fixed:
            ...
            frame:
                ypos 80
                add PyTGFX.scale_img("content/gfx/interface/pyp/jobs.webp", 350, 1000)
...
screen pyp_simulation():
    ...
    fixed:
        ...
        fixed:
            ...
            frame:
                ypos 80
                add PyTGFX.scale_img("content/gfx/interface/pyp/simulation.webp", 350, 1000)
