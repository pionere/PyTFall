screen pyp_se_guild():
    ...
    fixed:
        ...
        fixed:
            ...
            frame:
                xalign .5 ypos 80
                add PyTGFX.scale_img("content/gfx/interface/pyp/se_4.webp", 350, 1000)
...
screen pyp_se_teams():
    ...
    fixed:
        ...
        fixed:
            ...
            frame:
                xalign .5 ypos 80
                add PyTGFX.scale_img("content/gfx/interface/pyp/se_0.webp", 350, 1000)
...
screen pyp_se_log():
    ...
    fixed:
        ...
        fixed:
            ...
            frame:
                xalign .5 ypos 80
                add PyTGFX.scale_img("content/gfx/interface/pyp/se_1.webp", 350, 1000)
...
screen pyp_se_exploration_1():
    ...
    fixed:
        ...
        fixed:
            ...
            frame:
                xalign .5 ypos 80
                add PyTGFX.scale_img("content/gfx/interface/pyp/se_3.webp", 350, 200)
...
screen pyp_se_exploration_2():
    ...
    fixed:
        ...
        fixed:
            ...
            frame:
                xalign .5 ypos 80
                add PyTGFX.scale_img("content/gfx/interface/pyp/se_2.webp", 350, 1000)
