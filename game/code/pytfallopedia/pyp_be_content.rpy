screen pyp_battle_engine():
    ...
    fixed:
        ...
        fixed:
            ...
            frame:
                xalign .5 ypos 80
                add PyTGFX.scale_img("content/gfx/interface/pyp/combat_1.webp", 350, 1000)
...
screen pyp_teams():
    ...
    fixed:
        ...
        fixed:
            ...
            frame:
                xalign .5 ypos 80
                add PyTGFX.scale_img("content/gfx/interface/pyp/team1.webp", 350, 1000)
        ...
        fixed:
            ...
            frame:
                xalign .5 ypos 80
                add PyTGFX.scale_img("content/gfx/interface/pyp/team2.webp", 350, 1000)
...
screen pyp_attacks():
    ...
    fixed:
        ...
        fixed:
            ...
            frame:
                xalign .5 ypos 80
                add PyTGFX.scale_img("content/gfx/interface/pyp/combat_2.webp", 350, 1000)
    ...
    fixed:
        ...
        fixed:
            ...
            vbox:
                ...
                spacing 20
                frame:
                    add PyTGFX.scale_img("content/gfx/interface/pyp/magic1.webp", 350, 1000)
                frame:
                    add PyTGFX.scale_img("content/gfx/interface/pyp/magic0.webp", 350, 1000)
...
screen pyp_be_items():
    ...
    fixed:
        ...
        fixed:
            ...
            frame:
                xalign .5 ypos 80
                add PyTGFX.scale_img("content/gfx/interface/pyp/combat_4.webp", 350, 1000)
    ...
    fixed:
        ...
        fixed:
            ...
            vbox:
                ...
                spacing 20
                frame:
                    add PyTGFX.scale_img("content/gfx/interface/pyp/combat_5.webp", 350, 1000)
                frame:
                    add PyTGFX.scale_img("content/gfx/interface/pyp/combat_6.webp", 350, 1000)
