...
label fashion_show:
    ...
    $ style = [("lingerie", "lingeries"),
               ...
               ("cosplay", "cosplays"),
               ("cow", choice(["cow dresses", "cow costumes"])),
               ("cat", choice(["cat dresses", "cat costumes"])),
               ("bunny", choice(["bunny dresses", "bunny costumes"])),
               ("dog", choice(["dog dresses", "dog costumes"])),
               ("yukata", choice(["yukata gears", "yukata outfits"])),
               ("ninja", choice(["yukata gears", "yukata outfits"])),
