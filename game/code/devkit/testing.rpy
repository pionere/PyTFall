init 1000 python:
    class TestSuite(_object):
        ...
        @staticmethod
        def printGlobals():
            # "updater", "stored_random_seed" "style", , "anim" "blank" "build" "pickle", "last_inv_filter", 
            ...
            temp.update(["NextDayEvents", "tl", "AEQ_PURPOSES", "EQUIP_SLOTS", "hero", "items", "simple_jobs", "defeated_mobs", "fg_areas", "random_team_names", "pytfall", "FIGHTING_AEQ_PURPOSES", "main_menu", "tiered_items", "gen_occ_basetraits", "male_first_names", "rchars", "undefined", "gfx_overlay", "DEBUG", "DEBUG_SE", "DEBUG_CHARS", "DEBUG_AUTO_ITEM", "DSNBR", "DEBUG_BE", "DEBUG_SIMPY", "DEBUG_QE", "DEBUG_GUI", "DEBUG_PROFILING", "DEBUG_ND", "DEBUG_SIMPY_ND_BUILDING_REPORT", "DEBUG_INTERACTIONS", "DEBUG_LOG", "devlog", "chars", "ND_IMAGE_SIZE", "MOVIE_CHANNEL_COUNT", "tgs", "all_auto_buy_items", "result", "global_flags", "fighters", "mobs", "traits", "CLIENT_CASTES", "random_last_names", "tiered_magic_skills", "tiered_healing_skills", "char", "iam", "female_first_names", "IMAGE_EXTENSIONS", "MOVIE_EXTENSIONS", "CONTENT_EXTENSIONS", "MUSIC_EXTENSIONS", "IMG_NOT_FOUND_PATH", "last_label", "chars_list_state", "menu_extensions", "last_label_pure", "gamedir", "day", "npcs", "dungeons", "tisa_otm_adv", "pyp", "gazette", "calendar", "base_trait_presets", "base_traits_groups", "tagslog", "coords", "BDP", "tagdb", "SKILLS_MAX", "DAILY_EXP_CORE", "DAILY_AFF_CORE", "NEXT_MOVIE_CHANNEL", "MAX_TIER", "SKILLS_THRESHOLD", "_COLORS_", "battle_skills"])
            temp.update(["index", "equipment_safe_mode", "girls", "school_courses", "interactions_portraits_overlay"])
