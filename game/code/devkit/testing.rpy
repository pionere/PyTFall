init 1000 python:
    class TestSuite(_object):
        ...
        def printGlobals():
            ...
            temp.update(["NextDayEvents", "tl", "EQUIP_SLOTS", "hero", "items", "simple_jobs", "random_team_names", "pytfall", "main_menu", "tiered_items", "gen_occ_basetraits", "male_first_names", "rchars", "undefined", "gfx_overlay", "DEBUG", "DEBUG_SE", "DEBUG_CHARS", "DEBUG_AUTO_ITEM", "DSNBR", "DEBUG_BE", "DEBUG_SIMPY", "DEBUG_QE", "DEBUG_GUI", "DEBUG_PROFILING", "DEBUG_ND", "DEBUG_SIMPY_ND_BUILDING_REPORT", "DEBUG_INTERACTIONS", "DEBUG_LOG", "devlog", "chars", "ND_IMAGE_SIZE", "MOVIE_CHANNEL_COUNT", "tgs", "all_auto_buy_items", "result", "global_flags", "fighters", "mobs", "defeated_mobs", "fg_areas", "arena_chain_fights", "traits", "CLIENT_CASTES", "random_last_names", "tiered_magic_skills", "tiered_healing_skills", "iam", "female_first_names", "IMAGE_EXTENSIONS", "MOVIE_EXTENSIONS", "CONTENT_EXTENSIONS", "MUSIC_EXTENSIONS", "IMG_NOT_FOUND_PATH", "last_label", "chars_list_state", "menu_extensions", "last_label_pure", "gamedir", "day", "npcs", "dungeons", "tisa_otm_adv", "pyp", "gazette", "calendar", "tagslog", "tagdb", "DAILY_EXP_CORE", "DAILY_AFF_CORE", "NEXT_MOVIE_CHANNEL", "MAX_TIER", "_COLORS_", "battle_skills"])
            temp.update(["index", "equipment_safe_mode", "girls", "school_courses", "interactions_portraits_overlay", "char", "special_save_number", "world_events", "world_quests", "world_gossips", "battle", "effect_descs"])
