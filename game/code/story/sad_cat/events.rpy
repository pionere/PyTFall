init -1 python:
    register_event("found_sad_cat_1", locations=["main_street"], run_type="jump", priority=5000, start_day=1, restore_priority=0, times_per_days=(1,0))
...
label found_sad_cat_1:
    ...
    menu:
        "Pet it":
            ...
            $ register_event("found_sad_cat_2", locations=["main_street"], run_type="jump", priority=5000, start_day=day+1, restore_priority=0, times_per_days=(1,0))
        "Ignore it":
    ...
    if not(fish):
        ...
        menu:
            "Give some fish to the cat":
                ...
                $ register_event("found_sad_cat_3", locations=["main_street"], run_type="jump", priority=5000, start_day=day+1, restore_priority=0, times_per_days=(1,0))
            "Maybe later":
    ...
    if not(fish):
        ...
        menu:
            "Give some fish to the cat":
                ...
                $ register_event("found_sad_cat_4", locations=["main_street"], run_type="jump", priority=5000, start_day=day+1, restore_priority=0)
            "Maybe later":
                hero.say "I have a more important business to attend right now."
                hide temp with dissolve
            "Drive it away":
